...
class MarketTest < Minitest::Test
  ...
  def test_it_can_show_all_vendor_names
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_show_vendors_that_sell_a_specific_item
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_return_array_of_all_items_sold_without_repition
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_give_all_markets_inventory
    market = Market.new("South Pearl Street Farmers Market")
